...
const manualTranslations = {
  ...
  "Two much colour": "Слишком много цвета",
  "Gnat a problem": "Комариная проблема",
  "Feed the Flock": "Накормить стаю",
  "Wisdom within the Woods": "Мудрость леса",
  "Focus Fuel": "Топливо для концентрации",
  "Rest in Peace": "Покойся с миром",
  "Refuel my Fellow Machines": "Заправить собратьев-машин",
  "Remember the Mystic": "Вспомнить мистика",
  "The Sweet Escape": "Сладкий побег",
  "The Burning Hunger": "Жгучий голод",
  "A Toast to Enlightenment": "Тост за просветление",
  "A Piece of Zen": "Частица дзена",
  "Keeping the Peace": "Сохраняя мир",
  "Grizzly Shiny Glory": "Сияющая слава Гризли",
  "Love Potion No. 9": "Любовное зелье № 9",
  "Price of Punishment": "Цена наказания",
  "Eight Legged Freaks": "Восьминогие уродцы",
  "Guarding green": "Охраняя зелень",
  "Slippery Passage": "Скользкий проход",
  "Unbottling Mercy": "Милосердие из бутылки",
  "Mana Market Resupply": "Пополнение рынка маны",
  "Threading the Dream": "Нить сквозь сон",
  "Cigar Tales with Grizzly O'Brien": "Сигарные истории с Гризли О’Брайеном",
  "A Taste to Die For": "Вкус, за который стоит умереть",
  "A Nutty Situation": "Ореховая ситуация",
  "Feeding Frenzy": "Пищевая лихорадка",
  "Thistlebrook's Terrifying Task": "Ужасное поручение Тистлбрука",
  "Ancient Artifacts": "Древние артефакты",
  "Lucky Love": "Счастливая любовь",
  "Funny Bunny": "Забавный кролик",
  "Rehearsed Sabotage": "Отрепетированный саботаж",
  "Catching Dreams": "Ловцы снов",
  "Scattered Collectibles": "Разбросанные ценности",
  "Byte's Calling Card Investigation": "Расследование визитной карточки Байта",
  "The Matricidal Theory": "Теория матереубийства",
  "A Fortune Forewarned": "Предсказанная судьба",
  "Rock and Keg Roll": "Рок-н-бочка",
  "The Elusive Cheese": "Неуловимый сыр",
  "Exotic Attire Acquisition": "В поисках экзотического наряда",
  "Law and Order Protocols": "Протоколы закона и порядка",
  "A Sharp Donation": "Острое пожертвование",
  "Secrets Beneath": "Тайны под землёй",
  "The Young Woodraptor Predicament": "Проблема молодых древесных рапторов",
  "Grimbleton's Great Recipe Hunt": "Великая охота Гримблтона за рецептом",
  "Study of the Wooden Deer": "Исследование древесного оленя",
  "Dismantling the Dendroid Guard": "Разбор дендроидной стражи",
  "Clean Up on Bong Island": "Уборка на острове Бонг",
  "A Second Chance": "Второй шанс",
  "A Bitter Brew": "Горькое варево",
  "Secrets of the Invaders": "Тайны захватчиков",
  "Thirst for Understanding": "Жажда понимания",
  "Unearthing Obsession": "Раскапывая одержимость",
  "Proving the Steel": "Испытание стали",
  "Proof of Purification": "Доказательство очищения",
  "Loose ends": "Незавершённые дела",
  "Heartbeat of the Party": "Сердце вечеринки",
  "Guilt and Gears": "Вина и шестерни",
  "Echoes of Atonement": "Эхо искупления",
